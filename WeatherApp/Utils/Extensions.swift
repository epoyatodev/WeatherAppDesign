...
extension Color {
    ...
    static let borderTabBar = Color("Tab Bar Border").opacity(0.5)
    static let backgroundForeCastCard = Color("Forecast Card Background")
    static let textProbability = Color("Probability Text")
}
